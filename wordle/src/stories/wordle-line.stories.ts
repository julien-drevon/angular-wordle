...
export const simpleExemple: Story = {
  args: {
    line:[new WordleLetter("T",WordleState.placement), new WordleLetter("C",WordleState.good),new WordleLetter("D",WordleState.bad),new WordleLetter("O",WordleState.good)],
  },
};
export const goodLineExemple: Story = {
  args: {
    line:[new WordleLetter("O",WordleState.good), new WordleLetter("C",WordleState.good),new WordleLetter("T",WordleState.good),new WordleLetter("O",WordleState.good)],
  },
};