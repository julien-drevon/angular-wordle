...
describe('WordleLineComponent', () => {
  ...
  it("quand je definie une ligne toutes les wordle-case doivent y etre", ()=>{
    ...
    component.line = [new WordleLetter("A",WordleState.good), new WordleLetter("B",WordleState.placement)];
    fixture.detectChanges();
    
    expect(fixture.debugElement.queryAll(By.css(".wordle-letter"))).toHaveLength(2);
  })
  ...
  it("quand je definie une ligne ou toute les terres sont good, on doit avoir le style good-word", ()=>{
    ...
    component.line = [new WordleLetter("A",WordleState.good), new WordleLetter("B",WordleState.good)];
    fixture.detectChanges();
