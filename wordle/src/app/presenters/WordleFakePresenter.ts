...
export class WordleDefaultPresenter<TIn>
  implements IMPresenter<TIn,WordleGameResult>
{
  constructor(
    public convertTinToWordleGameResult: (data: TIn) => WordleGameResult
  ) {}
...
const converterForFakePresenter = (data:WordleGameResult)=>data;

export const createFakePresenter =()=> new WordleDefaultPresenter(converterForFakePresenter);
